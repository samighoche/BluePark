...
noble.on('discover', function(peripheral) {
	...
	console.log('Discovered Peripheral : ' + peripheral.uuid + 'Data : ' + peripheral.advertisement.manufacturerData + ' RSSI:' + peripheral.rssi + 'count:' + dict[peripheral.uuid].count);
